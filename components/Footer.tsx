        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary leading-relaxed mb-5">
              Sovereign security software for regulated Australian organisations — compliance enforced continuously, on infrastructure that stays onshore.
            </p>
            {/* Social links */}
            <div className="flex items-center gap-3">
              ...
              {/* X (@auresta_ai) and Medium (@auresta-ai) were linked here but neither account
                  exists — both 404. Re-add once they are registered; a dead social link on a live
                  site is worse than one fewer icon. */}
            </div>
          </div>
